  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (this.element.is('input') && !this.singleDatePicker && this.autoUpdateInput) {
            this.element.val(this.formatter(this.startDate) + this.locale.separator + this.formatter(this.endDate));
            this.element.trigger('change');
        } else if (this.element.is('input') && this.autoUpdateInput) {
            this.element.val(this.formatter(this.startDate));
            this.element.trigger('change');
        }
    ...
    DateRangePicker.prototype = {
        ...
        updateFormInputs: function() {
            this.container.find('input[name=daterangepicker_start]').val(this.formatter(this.startDate));
            if (this.endDate)
                this.container.find('input[name=daterangepicker_end]').val(this.formatter(this.endDate));
        ...
        hoverRange: function(e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                this.container.find('input[name=daterangepicker_start]').val(this.formatter(dates[0]));
                this.container.find('input[name=daterangepicker_end]').val(this.formatter(dates[1]));
            }
        },
        ...
        hoverDate: function(e) {
            ...
            if (this.endDate) {
                this.container.find('input[name=daterangepicker_start]').val(this.formatter(date));
            } else {
                this.container.find('input[name=daterangepicker_end]').val(this.formatter(date));
            }
